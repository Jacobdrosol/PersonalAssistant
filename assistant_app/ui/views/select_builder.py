...
class SelectBuilderView(ttk.Frame):
    _PIN_CODE = "12345"
    ...
    def __init__(self, master: tk.Misc) -> None:
        ...
        ttk.Label(header, text="Select Builder", style="SidebarHeading.TLabel").pack(side=tk.LEFT)
    ...
    def _show_lock_overlay(self) -> None:
        ...
        ttk.Label(
            card,
            text="Select Builder tab is under development.",
    ...
    def notify_locked(self) -> None:
        messagebox.showinfo("Select Builder", "Enter the PIN to unlock this tab.", parent=self)
