...
class KnowledgeBankView(ttk.Frame):
    _PIN_CODE = "12345"
    ...
    def __init__(self, master: tk.Misc) -> None:
        ...
        ttk.Label(header, text="Knowledge Bank", style="SidebarHeading.TLabel").pack(side=tk.LEFT)

        description = ttk.Label(
            self,
            text="Documents and knowledge center to assist with work.",
            wraplength=780,
            justify="left",
        )
    ...
    def _show_lock_overlay(self) -> None:
        ...
        ttk.Label(
            card,
            text="Knowledge Bank tab is under development.",
    ...
    def notify_locked(self) -> None:
        messagebox.showinfo("Knowledge Bank", "Enter the PIN to unlock this tab.", parent=self)
