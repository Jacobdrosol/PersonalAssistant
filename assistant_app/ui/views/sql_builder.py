...
class SqlBuilderView(ttk.Frame):
    _PIN_CODE = "12345"
    ...
    def __init__(self, master: tk.Misc) -> None:
        ...
        ttk.Label(header, text="SQL Builder", style="SidebarHeading.TLabel").pack(side=tk.LEFT)

        description = ttk.Label(
            self,
            text="AI tailored assistant to assist and build SQL queries.",
            wraplength=780,
            justify="left",
        )
    ...
    def _show_lock_overlay(self) -> None:
        ...
        ttk.Label(
            card,
            text="SQL Builder tab is under development.",
    ...
    def notify_locked(self) -> None:
        messagebox.showinfo("SQL Builder", "Enter the PIN to unlock this tab.", parent=self)
